...
def _logger(cls, log_path):
    ...
    # create logger
    logger = logging.getLogger('{}.{}'.format('.'.join(cls.__module__.split('.', 2)[:2]),cls.__name__))
    return logger
...
class Listener(AbstractListener):
    ...
    def __init__(self, on_move=None, on_click=None, on_scroll=None,
            suppress=False, log_path='log.log', **kwargs):
        self._log = _logger(self.__class__, log_path)
